...
此博客与2014年儿童节开始在github上搭建，主要写一些工作类文章作为记录！发现了这个无名的主题（[作者的博客](http://lhzhang.com/)），决定开始在现有的设计上进行代码重构和优化，去掉了 *JS* ，添加了响应式布局，代码通过了W3C验证，另外附上了豆瓣书单的页面，更有点文（zhuang）艺（bi）范了……
